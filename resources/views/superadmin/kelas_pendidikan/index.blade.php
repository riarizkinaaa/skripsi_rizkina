                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="col-md-4 ">
                                    {!! Form::text('q', request('q'), ['class' => 'form-control form-control-sm', 'placeholder' => 'Cari Nama Kelas Pendidikan']) !!}
                                </div>
                                <div class="col-md-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="{{$item->id_kelas_pendidikan}}"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="kelaspendidikan/{{$item->id_kelas_pendidikan}}" method="POST" class="d-inline ">
                                            @csrf
                                            @method('DELETE')
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('kelaspendidikan.store') }}" method="POST">

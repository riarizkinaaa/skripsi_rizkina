...
@section('title')Prestasi Formal {{ $title }}
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="{{$formal->id_prestasi_formal}}"><i class="fa fa-edit"></i></button>

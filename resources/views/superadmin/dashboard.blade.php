...
document.getElementById('tahun').addEventListener('change', function() {
  tahunYangDipilih = parseInt(this.value); // Ambil nilai tahun yang dipilih dari elemen select dan ubah ke tipe integer
  console.log("Tahun yang dipilih:", tahunYangDipilih); // Cek apakah event listener dipicu dengan benar

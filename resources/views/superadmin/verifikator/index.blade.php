    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="row p-3">
                    <div class="col-md-2">
                        <button class="btn btn-sm btn-primary" hidden type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal">Add New</button>
                    </div>
                    <div class="col-md-10">
                        ...
                        <table class="table table-striped table-hover table-bordered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->email}}</td>
                                    <td>
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" hidden type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="{{$item->id_pendidikan}}"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="verifikator/{{$item->id_verifikator}}" method="POST" class="d-inline ">
                                            @csrf
                                            @method('DELETE')

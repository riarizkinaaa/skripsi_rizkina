...
<head>
  ...
  <!-- Font Awesome-->
  @includeIf('layouts.verifikator.partials.css')
</head>
...
<body>
  ...
  <div class="page-wrapper compact-sidebar" id="pageWrapper">
    <!-- Page Header Start-->
    @includeIf('layouts.verifikator.partials.header')
    <!-- Page Header Ends -->
    <!-- Page Body Start-->
    <div class="page-body-wrapper sidebar-icon">
      <!-- Page Sidebar Start-->
      @includeIf('layouts.verifikator.partials.sidebar')
      <!-- Page Sidebar Ends-->
      <div class="page-body">
  ...
  <!-- latest jquery-->
  @includeIf('layouts.verifikator.partials.js')
</body>

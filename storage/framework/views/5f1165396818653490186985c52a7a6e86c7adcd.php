                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nama_kecamatan" class="form-control" id="nama_kecamatana"
                                        readonly>
                                </div>
                            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(document).ready(function() {
                ...
                $('#survior').change(function() {
                    var surviorId = $(this).val();
                    // console.log(surviorId);

                    if (surviorId) {
                        // Lakukan AJAX request
                        $.ajax({
                            url: '/superadmin/get-kecamatan/',
                            type: 'GET',
                            data: {
                                survior: surviorId
                            },
                            ...
                            error: function(xhr, textStatus, errorThrown) {
                                console.log("Error: ", xhr
                                    .responseText); // Cetak pesan kesalahan ke konsol
                            }
                        });
                    } else {
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Music\pmks_pengembangan_2-master\resources\views/superadmin/anak/formadd.blade.php ENDPATH**/ ?>
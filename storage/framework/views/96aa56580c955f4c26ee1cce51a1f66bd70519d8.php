                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="survior" id="survior" class="js-example-basic-single">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $survior; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ids => $nama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value=<?php echo e("$ids"); ?> <?php if($model->id_survior== $ids): ?> selected='selected' <?php endif; ?>><?php echo e($nama); ?></option>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.koordinator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\pmks_pengembangan_2-master\resources\views/koordinator/anak/formedit.blade.php ENDPATH**/ ?>
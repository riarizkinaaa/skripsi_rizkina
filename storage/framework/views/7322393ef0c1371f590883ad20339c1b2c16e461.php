    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="row m-3">
                    <div class="col-md-12">
                        <?php echo Form::open(['route' => $routePrefix, 'method' => 'GET']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="row mt-2 justify-content-end">
                                <div class="col-md-4 ">
                                    ...
                                    <a href="<?php echo e(route($routePrefix)); ?>" class="btn btn-sm btn-danger"><i class="fa fa-filter"></i> Clear</a>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="export_anak_belumver" method="GET">
                    <div class="row">
                        <div class="row">
                            <div class="col-md-4">
                                <?php echo Form::select('id_survior', $survior, request('id_survior'), [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.pimpinan.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Music\skripsi\pmks_pengembangan_2-master\resources\views/pimpinan/anak/belum_verifikasi.blade.php ENDPATH**/ ?>
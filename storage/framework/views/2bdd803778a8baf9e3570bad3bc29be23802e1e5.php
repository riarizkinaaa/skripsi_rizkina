    ...
    <div class="page-wrapper landing-page">
        ...
        <div class="page-body-wrapper">
                        ...
                        <div class="col-12">
                            <nav class="navbar navbar-light p-0" id="navbar-example2"><a class="navbar-brand"
                                    href="javascript:void(0)"> <img class="img-fluid"
                                        src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt=""></a>
            ...
            <section class="landing-home section-pb-space" id="home"><img class="img-fluid bg-img-cover"
                    src="<?php echo e(asset('assets/images/landing/landing-home/home-bg2.jpg')); ?>" alt="">
                <div class="custom-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="landing-home-contain">
                                <div>
                                    <div class="landing-logo"><img class="img-fluid"
                                            src="<?php echo e(asset('assets/images/logo/icon-logo.png')); ?>" alt="">
                                    </div>
...
<?php /**PATH C:\Users\ASUS\Downloads\tugas akhir\tugas akhir\skripsi\pmks_pengembangan_2-master\resources\views/home.blade.php ENDPATH**/ ?>
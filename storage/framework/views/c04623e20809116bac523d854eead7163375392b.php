    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e($route_export); ?>" method="GET">
                    <div class="row">
                        <div class="row">
                            <div class="col-md-4">
                                <?php echo Form::select('id_survior', $survior, request('id_survior'), [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.verifikator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\pmks_pengembangan_2-master\resources\views/verifikator/anak/index.blade.php ENDPATH**/ ?>
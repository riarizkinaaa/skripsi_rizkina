                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="col-md-4 ">
                                    <?php echo Form::text('q', request('q'), ['class' => 'form-control form-control-sm', 'placeholder' => 'Cari Nama Kelas Pendidikan']); ?>
                    ...
                    <div class="dt-ext table-responsive">
                        <table class="table table-bordered table-striped table-hover table-sm m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($i++); ?></td>
                                    <td><?php echo e($item->kelas_pendidikan); ?></td>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="<?php echo e($item->id_kelas_pendidikan); ?>"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="kelaspendidikan/<?php echo e($item->id_kelas_pendidikan); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('kelaspendidikan.store')); ?>" method="POST">
...
<script>
    $(function() {
        ...
        $('.tombol-ubah').on('click', function() {
            ...
            $('.form-ubah form').attr('action', 'kelaspendidikan/' + id)
            // console.log(id);

            $.ajax({
                url: `kelaspendidikan/` + id + `/edit`,
                method: 'get',
                dataType: 'json',
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Music\pmks_pengembangan_2-master\resources\views/superadmin/kelas_pendidikan/index.blade.php ENDPATH**/ ?>
                        ...
                        <div class="row">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    ...
                                    <?php $__currentLoopData = $anakPerKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p>Jumlah <?php echo e($anak->nama_kecamatan); ?>: <?php echo e($anak->total_anak); ?></p>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\tugas akhir\tugas akhir\skripsi\pmks_pengembangan_2-master\resources\views/superadmin/anak/index.blade.php ENDPATH**/ ?>
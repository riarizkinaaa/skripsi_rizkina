...
<body>
  ...
  <div class="page-wrapper compact-sidebar" id="pageWrapper">
    <!-- Page Header Start-->
    <?php if ($__env->exists('layouts.koordinator.partials.header')) echo $__env->make('layouts.koordinator.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Page Header Ends -->
    <!-- Page Body Start-->
    <div class="page-body-wrapper sidebar-icon">
      <!-- Page Sidebar Start-->
      <?php if ($__env->exists('layouts.koordinator.partials.sidebar')) echo $__env->make('layouts.koordinator.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <!-- Page Sidebar Ends-->
      <div class="page-body">
...
</html><?php /**PATH C:\Users\ASUS\Music\skripsi\pmks_pengembangan_2-master\resources\views/layouts/koordinator/master.blade.php ENDPATH**/ ?>
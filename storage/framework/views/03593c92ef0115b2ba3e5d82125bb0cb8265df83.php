                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 ">
                                    <?php echo Form::text('q', request('q'), ['class' => 'form-control form-control-sm', 'placeholder' => 'Cari Nama Desa']); ?>
                ...
                <div class="card-body">
                    <div class="dt-ext table-responsive">
                        <table class="table table-bordered table-striped table-hover table-sm m-0">
                            ...
                            <tbody>
                                <h4>Hasil : <?php echo e($totalDesa); ?></h4>
                                <?php
                                $i = $models->firstItem();
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="<?php echo e($item->id_desa); ?>"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="/alamat/desa/<?php echo e($item->id_desa); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Music\skripsi\pmks_pengembangan_2-master\resources\views/superadmin/desa/index.blade.php ENDPATH**/ ?>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="col-md-4 ">
                                    <?php echo Form::text('q', request('q'), ['class' => 'form-control form-control-sm', 'placeholder' => 'Cari Nama Kecamatan']); ?>
                        ...
                        <table class="table table-bordered table-striped table-hover table-sm m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($item->file1): ?>
                                            <?php echo e(basename($item->file1, '.' . pathinfo($item->file1, PATHINFO_EXTENSION))); ?>
                                    ...
                                    <td>
                                        <?php if($item->file2): ?>
                                            <?php echo e(basename($item->file2, '.' . pathinfo($item->file2, PATHINFO_EXTENSION))); ?>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="<?php echo e($item->id_kecamatan); ?>"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="kecamatan/<?php echo e($item->id_kecamatan); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 draggable">
                        ...
                        <input type="file" name="file1" class="form-control btn-square <?php $__errorArgs = ['file1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 draggable">
                        ...
                        <input type="file" name="file2" class="form-control btn-square <?php $__errorArgs = ['file2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\pmks_pengembangan_2-master\resources\views/superadmin/kecamatan/index.blade.php ENDPATH**/ ?>